...
Usage:
    python -m scripts.full_detail_pull --cmc-id 2586                 # Synthetix
    python -m scripts.full_detail_pull --cmc-id 1                    # Bitcoin
    python -m scripts.full_detail_pull --cmc-id 2586 --cg-id havven  # skip auto-mapping
    python -m scripts.full_detail_pull --cmc-id 2586 --csv out.csv
    python -m scripts.full_detail_pull --cmc-id 2586 --xlsx out.xlsx
